...
//  (a) Begin the definition a function called array_total that returns the
...
long long int array_total(int arr[], int arr_size) {
...
int main(void)
{
    ...
    long long int result = array_total(items, array_size);
